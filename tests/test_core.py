...
def test_find_blocks_single():
    row1 = ["", "", "", "Розрахунок", "Розрахунок", "M2026-05", "M2026-05"]
    row3 = ["№", "Водій", "Планова витрата", "Пробіг км", "Витрата палива",
            "16.05.26", "15.05.26"]
    assert find_mileage_blocks(row1, row3) == [(3, "M2026-05")]


def test_find_blocks_two_months():
    # Свежий блок слева (Червень), старый справа (Травень)
    row1 = ["", "", "", "Розрахунок", "Розрахунок", "M2026-06",
            "Розрахунок", "Розрахунок", "M2026-05", "M2026-05"]
    row3 = ["№", "Водій", "Планова витрата", "Пробіг км", "Витрата палива",
            "01.06.26", "Пробіг км", "Витрата палива", "16.05.26", "15.05.26"]
    assert find_mileage_blocks(row1, row3) == [(3, "M2026-06"), (6, "M2026-05")]


def test_find_blocks_none():
    assert find_mileage_blocks(["", ""], ["№", "Водій"]) == []
